...
public:
    ...
    static MatrixXu train_data_delta, train_label_delta;
    static MatrixXu test_data, test_label;
    static MatrixXu test_data_delta, test_label_delta;
    ...
    static MatrixXu secret_share(MatrixXu &truth, MatrixXu &gamma);
    static void secret_share(MatrixXu &data, MatrixXu &label, string category);
    static void load_ss(ifstream &in, MatrixXu &data, MatrixXu &label, ifstream &in_delta, MatrixXu &data_delta, MatrixXu &label_delta, int size);
};
